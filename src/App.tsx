            ...
            <div className="container-fluid">
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <ul className="navbar-nav me-auto mb-2 mb-md-0">
                        <li className="nav-item"><Link className="nav-link" to="/np1" style={{padding: 5}}>1.NP</Link></li>
                        <li className="nav-item"><Link className="nav-link" to="/np2" style={{padding: 5}}>2.NP</Link></li>
